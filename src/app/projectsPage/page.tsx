        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-24 p-24 w-full">
          <div className="card flex flex-col ">
            ...
            <div className="flex justify-between mt-6 items-center px-4">
              <span className=" text-center font-semibold ">Project 1</span>
          ...
          <div className="card flex flex-col ">
            ...
            />
            <div className="flex justify-between mt-6 items-center px-4">
              <span className=" text-center font-semibold ">Project 2</span>
          ...
          <div className="card flex flex-col ">
            ...
            />
            <div className="flex justify-between mt-6 items-center px-4">
              <span className=" text-center font-semibold ">Project 3</span>
          ...
          <div className="card flex flex-col ">
            ...
            />
            <div className="flex justify-between mt-6 items-center px-4">
              <span className=" text-center font-semibold ">Project 4</span>
          ...
          <div className="card flex flex-col ">
            ...
            />
            <div className="flex justify-between mt-6 items-center px-4">
              <span className=" text-center font-semibold ">Project 5</span>
          ...
          <div className="card flex flex-col ">
            ...
            />
            <div className="flex justify-between mt-6 items-center px-4">
              <span className=" text-center font-semibold ">Project 6</span>
